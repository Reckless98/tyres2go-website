        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-gray-900">
              Why Choose Tyres2Go for Auto Services?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive automotive repairs and prompt service at our Riccarton facility. We serve private car owners and commercial fleets with experienced mechanics and modern facilities.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {companyValues.tyres2go.additionalValues.slice(4, 7).map((value, index) => (
              <motion.div
                key={value.title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
